...
- **Neutrik NC3MXX** male XLR connector — must be the newer revision with the
  bushing thread machined *inside* the shell (the printed part screws into
  that thread)
...
- **Layer height:** 0.16–0.20 mm, **perimeters:** 4, **infill:** 40–60 %
...
Dimensional provenance, revision history and the reasoning behind the
geometry live in [SPEC.md](SPEC.md).
